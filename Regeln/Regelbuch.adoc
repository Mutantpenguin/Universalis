...
// TODO vieleicht ganz anders, und einfach angeben um Sichtlinien "durch" das Objekt möglich sind?
...
Die Rüstungswürfe dadurch getroffener Modelle werden immer so behandelt als ob sie sich in harter Deckung befinden.
...
// TODO EH anstelle von Wahrnehmungsbereich? Wenn ja, dass Fähigkeit zur Erhöhung der Reichweite
