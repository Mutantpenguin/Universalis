...
Dies passiert solange, bis ein Spieler keine Aktivierungskarten mehr hat. Der andere Spieler kann nun etwaige weitere Modelle in beliebiger Reihenfolge aktivieren.
