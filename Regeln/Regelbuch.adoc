...
// TODO vielleicht ganz anders, und einfach angeben um Sichtlinien "durch" das Objekt möglich sind?

// TODO schlechte/gute/normale Sicht?
...
Flächenwaffen erzeugen an ihrem Einschlagpunkt eine Flächenwirkung die im jeweiligen Waffenprofil in cm angegeben ist und eine kreisrunde Fläche mit diesem Radius in cm beschreibt.
