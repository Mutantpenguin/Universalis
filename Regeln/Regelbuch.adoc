...
|Schwierig
a|Jede Bewegungsaktion die in, aus oder durch diese Geländeteil führt wird halbiert (aufgerundet).
...
[[Größenunterschiede]]
==== Größenunterschiede(((Größenunterschiede)))(((Nahkampf, Größenunterschiede)))
