...
|Kräfte
|image:Grafiken/Allgemein/aktion.svg[link=#Kräfte-Aktionen]
|image:Grafiken/Allgemein/reaktion.svg[link=#Kräfte-Reaktionen]
...
Sobald eine Drohne <<Eliminiert,eliminiert>> wurde, kommt es zu einer Rückkopplung auf den Kontroller, welche ihm Schaden zufügen kann.
