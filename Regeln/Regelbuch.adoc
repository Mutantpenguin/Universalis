...
* Ein Tisch mit einer Fläche von mindestens 36" * 36".
+
[.text-center]
...
Die Fläche des Spielfeldes muss exakt 36" * 36" betragen.
...
Um sie anzuwenden muss die Aktion _Eigenschaft anwenden_ ausgeführt werden.
...
Um sie zu benutzen muss die Aktion _Ausrüstung verwenden_ ausgeführt werden.
...
Der Begriff ist ein Kunstwort aus _Tele_ (fern) und _Automaton_ (automatisches Wesen oder Maschine).
...
[%unbreakable]
====
* Eine Hexe hat die Eigenschaft _Vertrauter II_. Sie darf dadurch 2 zugeordnete Telematons haben.
* Mit dem _R3MOTE α Fernsteuerdeck_ kann ein Straßensamurai 1 zugeordneten Telematon haben.
* Ein Prospektor verfügt über 3 _Lenk-Module_ für seinen Anzug und kann damit 3 zugeordnete Telematons haben.
====
