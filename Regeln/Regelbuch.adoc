...
| image:Grafiken/Modell/Begleiter.svg[Begleiter,40]
| <<Begleiter>>
...
[[Operatoren]]
=== ((Operatoren))(((Begleiter, Operatoren)))
...
=== Zuordnung(((Begleiter, Zuordnung)))

Begleiter können und müssen immer genau einem Operator zugeordnet sein.
