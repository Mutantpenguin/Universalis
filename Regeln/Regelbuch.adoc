...
a|* "Hacking III" um ein Terminal der Stufe III zu hacken.
* "Schlossknacken" um Schlösser zu knacken.

|Schwierigkeit
|<<Attributswurf>> mit optionalem Modifikator notwendig.
a|* KO-Test um die Winde eines Falltors zu drehen.
* WN-2-Test um ein elektronisches Schloss kurz zu schließen.

|Komplex
|Alles ist möglich.
a|* Das Modell muss einen speziellen Gegenstand wie z.B. Schlüssel oder Keycard besitzen.
